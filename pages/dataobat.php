			...
			<tbody>
				...
				?>
					<tr>
						...
						<td class="td-opsi">
							<button class="btn-transition btn btn-outline-success btn-sm" title="detail obat" id="tombol_detail" name="tombol_detail" data-toggle="modal" data-target="#detail_obat" data-kode="<?php echo $data['kd_obat']; ?>" data-nama="<?php echo $data['nm_obat']; ?>" data-exp="<?php echo tgl_indo($data['exp_obat']); ?>" data-ktg="<?php echo $data['ktg_obat']; ?>" data-bentuk="<?php echo $data['bnt_obat']; ?>" data-satuan="<?php echo $data['sat_obat']; ?>" data-harbel="<?php echo "Rp" . number_format($data['hrgbeli_obat'], 0, ",", "."); ?>" data-harju="<?php echo "Rp" . number_format($data['hrg_obat'], 0, ",", ".");; ?>" data-stok="<?php echo $data['stk_obat']; ?>" data-minstok="<?php echo $data['minstk_obat']; ?>">
