					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<textarea name="nm_obat" id="nm_obat" rows="2" class="form-control"  style="font-size: 14px; height: 90px;" readonly=""  ><?php echo $data['nm_obat']; ?></textarea>
