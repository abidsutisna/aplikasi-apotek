		...
		<div class="row" style="padding: 0 16px;">
			<div class="col-md-12 vertical-form">
                ...
                <form method="post" id="form-pembelian" autocomplete="off">
                    ...
                    <?php
                        $query_tampil = "SELECT * FROM tbl_dataobat WHERE kd_obat='$kode'";
                        $sql_tampil = mysqli_query($conn, $query_tampil) or die ($conn->error);
                        $data = mysqli_fetch_array($sql_tampil);

                        $query_prm = "SELECT * FROM tbl_obatramal WHERE kd_obat='$kode'    ";
				        $sql_prm = mysqli_query($conn, $query_prm) or die ($conn->error);
                        $data2 = mysqli_fetch_array($sql_tampil);
                    ?>
                    <div class="row kotak-form-tabel">
                    	<div class="col-md-3 kotak-form-obat-terjual" style="display: ;">
                    			<div class="position-relative form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="kode_obat" value="<?php echo $kode;?>" readonly="">
                                        <div class="input-group-append">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <input name="nm_obat" id="nm_obat" placeholder="" type="text" class="form-control form-control-sm" disabled="" value="<?php echo $data['nm_obat']; ?>">
                                </div>
                                <div class="position-relative form-group">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                      <input type="number" class="form-control" id="jml_obat" name="jml_obat" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"  placeholder=""    >
                                      <div class="input-group-append">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                      ...
                                      <input type="number" class="form-control" id="hrg_obat" name="hrg_obat" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="<?php echo $data['hrg_obat']; ?>">
                                  </div>
                                </div>
                                <div class="position-relative form-group">
