            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <?php if ($_SESSION['posisi_peg'] == 'Admin' || $_SESSION['posisi_peg'] == 'Manager' || $_SESSION['posisi_peg'] == 'Apoteker') { ?>
                    <td class="td-opsi">
                      <button class="btn-transition btn btn-outline-danger btn-sm" title="kosongkan" id="tombol_kosongkan<?php echo $data_30['kd_obat']; ?>" name="tombol_kosongkan" data-kd_obat="<?php echo $data_30['kd_obat']; ?>" data-exp="<?php echo $data_30['tgl_exp'] ?>" data-nm_obat="<?php echo $data_30['nm_obat'] ?>" data-stok="<?php echo $data_30['stok'] ?>">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <?php if ($_SESSION['posisi_peg'] == 'Admin' || $_SESSION['posisi_peg'] == 'Manager' || $_SESSION['posisi_peg'] == 'Apoteker') { ?>
                    <td class="td-opsi">
                      <button class="btn-transition btn btn-outline-danger btn-sm" title="kosongkan" id="tombol_kosongkan<?php echo $data_10['kd_obat']; ?>" name="tombol_kosongkan" data-kd_obat="<?php echo $data_10['kd_obat']; ?>" data-exp="<?php echo $data_10['tgl_exp'] ?>" data-nm_obat="<?php echo $data_10['nm_obat'] ?>" data-stok="<?php echo $data_10['stok'] ?>">
                        <i class="fas fa-minus-square"></i>
                      </button>
                    </td>
                  <?php } ?>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <?php if ($_SESSION['posisi_peg'] == 'Admin' || $_SESSION['posisi_peg'] == 'Manager' || $_SESSION['posisi_peg'] == 'Apoteker') { ?>
                    <td class="td-opsi">
                      <button class="btn-transition btn btn-outline-danger btn-sm" title="kosongkan" id="tombol_kosongkan<?php echo $data_telahexp['kd_obat']; ?>" name="tombol_kosongkan" data-kd_obat="<?php echo $data_telahexp['kd_obat']; ?>" data-exp="<?php echo $data_telahexp['tgl_exp'] ?>" data-nm_obat="<?php echo $data_telahexp['nm_obat'] ?>" data-stok="<?php echo $data_telahexp['stok'] ?>">
                        <i class="fas fa-minus-square"></i>
                      </button>
                    </td>
                  <?php } ?>
