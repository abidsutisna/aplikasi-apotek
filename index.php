...
<html lang="en">
  ...
  <body class="bg-light">
  	...
  	<div class="col-md-12 bg-info p-1 title">
  		...
  		<div class="row">
  			<div class="col-md-6">
  				<span class="text-white font-weight-light">Aplikasi Sesse Care</span>
  			</div>
          ...
          <div id="menu-collapse" class="collapse show" aria-labelledby="" data-parent="#menu">
            <div class="accordion" id="daftar_menu">
              <ul class="list-group">
                ...
                <a href="?page=entry_datapembelian" class="list-group-item list-group-item-action <?php if(@$_GET['page']=='datapembelian' || @$_GET['page']=='entry_datapembelian' || @$_GET['page']=='entry_datapembelian2') {echo "active";} ?>">
                  <i class="fas fa-shopping-bag"></i> Transaksi Pembelian
                </a>
                <a href="?page=obat_kurang" class="list-group-item list-group-item-action <?php if(@$_GET['page']=='obat_kurang') {echo "active";} ?>">
                  <i class="fas fa-capsules"></i> Stok Obat Kurang
                </a> 
                <a href="?page=peramalan" class="list-group-item list-group-item-action <?php if(@$_GET['page']=='peramalan' || @$_GET['page']=='hasil_peramalan' || @$_GET['page']=='peramalan2' ) {echo "active";} ?>">
                  <i class="fas fa-chart-bar"></i> Peramalan Penjualan
                </a>

                <a href="?page=riwayat_peramalan" class="list-group-item list-group-item-action <?php if(@$_GET['page']=='riwayat_peramalan') {echo "active";} ?>">
                  <i class="fas fa-file-alt"></i> Hasil Peramalan
                </a> 
              <?php } ?>
      ...
      <script src="asset/ChartJs/Chart.min.js"></script>
  		...
  		<div class="col-md-10 content">
              ...
              include 'pages/info_kadaluarsa.php';
		        ...
		        } else if(@$_GET['page']=='entry_datapembelian2') {
              include 'pages/form_entrypembelian2.php';
            }
		        ...
		        } else if(@$_GET['page']=='obat_kurang') {
              include 'pages/obat_kurang.php';
            }  else if(@$_GET['page']=='peramalan2') {
    
                include 'pages/peramalan2.php';
            }
  			 ?>
  		</div>
  	...
  	<footer>
  		<i class="fas fa-copyright"></i> Muhammad Abid Sutisna (18522043) (Universitas Islam Indonesia)
  	</footer>
    <!-- Optional JavaScript -->
